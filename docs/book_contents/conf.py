...
html_baseurl = ''
html_css_files = ['fix_dark_mode_tables.css', 'fix_dark_mode_output_images.css']
html_favicon = ''
html_logo = 'assets/logo.png'
html_sourcelink_suffix = ''
html_static_path = ['_static']
html_theme = 'sphinx_book_theme'
html_theme_options = {'search_bar_text': 'Search this book...', 'launch_buttons': {'notebook_interface': 'classic', 'binderhub_url': '', 'jupyterhub_url': '', 'thebe': False, 'colab_url': ''}, 'path_to_docs': 'docs/book_contents', 'repository_url': 'https://github.com/MantiMantilla/federated_learning/', 'repository_branch': 'main', 'extra_footer': '', 'home_page_in_toc': True, 'announcement': '', 'analytics': {'google_analytics_id': ''}, 'use_repository_button': True, 'use_edit_page_button': False, 'use_issues_button': True}
html_title = 'Federated Learning and Differential Privacy'
latex_engine = 'pdflatex'
myst_enable_extensions = ['dollarmath', 'substitution', 'colon_fence']
